...
import LogoImage from "../../public/logo-img.png";
    ...
    >
      <Nav>
        <LogoContainer>
          ...
          <Link href="/" className="cursor-pointer text-lg font-bold">Citizens <span className="text-green-600">Farmers</span> Bank</Link>
        </LogoContainer>
