        ...
        <div className="border-solid border-2 rounded border-green-200">
          ...
          <div className="p-10">
              ...
              <p className="text-[12px]">
                ...
                CFB Online®. Eligible CFB consumer accounts include deposit,
                loan, and credit accounts, but other consumer accounts may also
                be eligible. Contact CFB for details. Availability may be
                affected by your mobile carriers coverage area. Your mobile
              ...
              <p className="pt-7 text-[12px]">
                ...
                educational purposes and may not be the score used by CFB to
                make credit decisions. CFB looks at many factors to determine
                your credit options; therefore, a specific FICO® Score or CFB
                credit rating does not guarantee a specific loan rate, approval
                of a loan, or an upgrade on a credit card.
              </p>
              <p className="pt-7 text-[12px]">
                CFB and Fair Isaac are not credit repair organizations as
                defined under federal and state law, including the Credit Repair
                Organizations Act. CFB and Fair Isaac do not provide credit
                repair services or advice or assistance with rebuilding or
              ...
              <p className="pt-7 text-[12px]">
                ...
                Online® is required. Terms and conditions apply. U.S. checking
                or savings account required to use Zelle®. Transactions between
                ...
                smartphone. Payment requests to persons not already enrolled
                with Zelle® must be sent to an email address. To send or receive
                money with a small business, both parties must be enrolled with
                Zelle® directly through their financial institutions online or
                mobile banking experience. For more information, view the Zelle®
                Transfer Service Addendum to the CFB Online Access Agreement.
                Your mobile carriers message and data rates may apply. Account
