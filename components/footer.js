  ...
  return (
    <main className="bg-gray-100 mt-10">
      <div className="bg-gray-200 mt-10 m-auto mv:p-5 min-w-min">
        <div className="font-opensans text-[12px] pb-10">
          <Link className="hover:text-decoration-line:underline" href="#">Notice of Data Collection |</Link>
          <Link className="hover:text-decoration-line:underline" href="#">Privacy, Cookies, Security & Legal |</Link>
          <Link className="hover:text-decoration-line:underline" href="#">General Terms of Use |</Link>
          <Link className="hover:text-decoration-line:underline" href="#">Online Access Agreement |</Link>
          <Link className="hover:text-decoration-line:underline" href="#">Diversity and Accessibility |</Link>
          <Link className="hover:text-decoration-line:underline" href="#">Ad Choices |</Link>
          <Link className="hover:text-decoration-line:underline" href="#">Report Fraud |</Link>
          <Link className="hover:text-decoration-line:underline" href="/about">About Citizens Farmers Bank |</Link>
          <Link className="hover:text-decoration-line:underline" href="/about">Careers |</Link>
          <Link className="hover:text-decoration-line:underline" href="#">Sitemap</Link>
        </div>
        {/* SOCIAL MEDIA LOGO */}
        <div className="border-solid border-2 rounded border-green-200">
          <div className="flex gap-5 p-5 ">
            <Image alt="Facebook" src="/facebook.svg" width={30} height={30} />
            <Image alt="Facebook" src="/instagram.svg" width={30} height={30} />
            <Image alt="Facebook" src="/pinterest.svg" width={30} height={30} />
            <Image alt="Facebook" src="/linkedin.svg" width={30} height={30} />
          ...
          <div className="p-10">
            ...
            <p className="pt-7 font-opensans text-[12px]">
          ...
          <div className="m-10 border-solid border-2 border-gray-300">
            <h1 className="m-2 font-opensans font-bold">
              Investment and Insurance Products are:
            </h1>
            <h2 className="m-7 font-opensansitalic">
