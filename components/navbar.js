  ...
  return (
    <nav className="flex justify-between items-center p-20 mv:p-5">
      <div className="flex">
        ...
        <Image alt="" src='/logo-img.png' width={40} height={40}/>
        <span className="text-gray-700 font-burtons pt-1 ml-3 xs:text-[25px] hover:animate-bounce">
          Citizens <span className="text-green-600 xs:text-[25px]">Farmers</span> Bank
        </span>
      </div>
      {/* Branding closed */}
      ...
      <div className="flex mr-2">
        ...
        <div className="hidden xs:flex xs:mr font-serif-5">
          <ul className="flex space-x-5">
            <Link
              href="/"
              className="cursor-pointer font-semibold text-sm font-opensans text-gray-700 hover:text-green-600 "
            >
              Home
            </Link>
            <Link
